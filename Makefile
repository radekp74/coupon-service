...
.PHONY: help docs-check bootstrap-check emp003-check emp004-refinement-check emp006-refinement-check emp006-check emp007-check java-check docker-check compose-config docker-build docker-up docker-down docker-logs docker-smoke maven-verify verify checksums package export-source clean
