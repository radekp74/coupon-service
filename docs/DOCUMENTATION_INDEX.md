...
- [Review checklist EMP-008](project/refinements/EMP-008-review-checklist.md)
- [Review checklist EMP-009](project/refinements/EMP-009-review-checklist.md)
- [Review checklist EMP-010](project/refinements/EMP-010-review-checklist.md)
- [Review checklist EMP-011](project/refinements/EMP-011-review-checklist.md)
...
- [Podsumowanie refinementu EMP-008](project/refinements/EMP-008-summary.md)
- [Podsumowanie refinementu EMP-009](project/refinements/EMP-009-summary.md)
- [Podsumowanie refinementu EMP-010](project/refinements/EMP-010-summary.md)
- [Podsumowanie refinementu EMP-011](project/refinements/EMP-011-summary.md)
...
- [Refinement EMP-008 — coverage, JaCoCo i quality evidence](project/refinements/EMP-008.md)
- [Refinement EMP-009 — deterministyczne concurrency evidence](project/refinements/EMP-009.md)
- [Refinement EMP-010 — CI, delivery hardening i podstawowa obserwowalność](project/refinements/EMP-010.md)
- [Refinement EMP-011 — finalny review, README i closeout repozytorium](project/refinements/EMP-011.md)
