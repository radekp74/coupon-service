...
| EMP-006 | EMP-001 | P0 | READY | EMP-006 | Client IP i provider-neutral GeoIP | accepted EMP-006 refinement + `make emp006-refinement-check` |
...
- `EMP-006` jest `READY`: jego własny refinement został formalnie zaakceptowany, a implementacja pozostaje `NOT_STARTED` do osobnego checkpointu.
