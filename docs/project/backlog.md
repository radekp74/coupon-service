...
| EMP-008 | EMP-001 | P0 | READY | EMP-008 | Coverage, JaCoCo, test completeness i quality evidence | accepted refinement + JaCoCo `verify` gate + manual report review |
...
- `EMP-008` jest `READY`; refinement jest `ACCEPTED`, implementation `NOT_STARTED`, `Implementation-Allowed: YES`, a coverage evidence pozostaje `NOT_MEASURED` do realnego raportu JaCoCo.
